...
void main() {
  test(
    ...
    () async {
      final root =
          await File.fromUri(Uri.parse('${Directory.current.parent.parent.parent.path}/README.md')).readAsString();
      final local = await File.fromUri(Uri.parse('${Directory.current.parent.path}/README.md')).readAsString();
