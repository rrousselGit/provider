...
class ListenableProxyProvider<T, R extends Listenable?>
  ...
  ListenableProxyProvider({
    ...
    TransitionBuilder? builder,
    Widget? child,
    bool Function(T value)? searchCallback,
  }) : super(
          key: key,
          create: create,
          lazy: lazy,
...
class ListenableProxyProvider2<T, T2, R extends Listenable?>
  ...
  ListenableProxyProvider2({
    ...
    TransitionBuilder? builder,
    Widget? child,
    bool Function(T value)? searchCallback1,
    bool Function(T2 value)? searchCallback2,
  }) : super(
          key: key,
          create: create,
          lazy: lazy,
...
class ListenableProxyProvider3<T, T2, T3, R extends Listenable?>
  ...
  ListenableProxyProvider3({
    ...
    bool Function(T value)? searchCallback1,
    bool Function(T2 value)? searchCallback2,
    bool Function(T3 value)? searchCallback3,
  }) : super(
          key: key,
          create: create,
          lazy: lazy,
...
class ListenableProxyProvider4<T, T2, T3, T4, R extends Listenable?>
  ...
  ListenableProxyProvider4({
    ...
    bool Function(T2 value)? searchCallback2,
    bool Function(T3 value)? searchCallback3,
    bool Function(T4 value)? searchCallback4,
  }) : super(
          key: key,
          create: create,
          lazy: lazy,
...
class ListenableProxyProvider5<T, T2, T3, T4, T5, R extends Listenable?>
  ...
  ListenableProxyProvider5({
    ...
    bool Function(T3 value)? searchCallback3,
    bool Function(T4 value)? searchCallback4,
    bool Function(T5 value)? searchCallback5,
  }) : super(
          key: key,
          create: create,
          lazy: lazy,
...
class ListenableProxyProvider6<T, T2, T3, T4, T5, T6, R extends Listenable?>
  ...
  ListenableProxyProvider6({
    ...
    bool Function(T4 value)? searchCallback4,
    bool Function(T5 value)? searchCallback5,
    bool Function(T6 value)? searchCallback6,
  }) : super(
          key: key,
          create: create,
          lazy: lazy,
